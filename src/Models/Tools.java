...
public class Tools {
    ...
    public static ResultSet getResult(String query) throws IOException, SQLException {
    ...
    {
        return  "SELECT * FROM kernel." + tableName +" WHERE " + keyColumn+" = " + key;
    }
    ...
    {
        return  "UPDATE kernel." + tableName + " SET " + updateColumn + " =  " +  value + " WHERE "+ keyColumn +" = " + key;
    }

    public static long insert(String tableName, Map<String, Object> args) throws IOException, SQLException {
        var stringBuilder = new StringBuilder("INSERT kernel.");
